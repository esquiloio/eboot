...
#define FATBootSec          0
#define FATTable0Sec0       0x1
#define FATTable1Sec0       0xfb 
#define FATRootDirSec0      0x1f5
#define FATDataSec0         0x215

#define FATFileNameSize     11

void FATReadLBA(uint32_t FAT_LBA,uint8_t *pu8DataPointer);
