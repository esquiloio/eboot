...
# CMAKE_BUILD_TYPE
IF(NOT CMAKE_BUILD_TYPE MATCHES Debug|Develop)
...
ELSEIF(CMAKE_BUILD_TYPE MATCHES Develop)
    SET(EXECUTABLE_OUTPUT_PATH ${PROJECT_BINARY_DIR}/develop)
    SET(LIBRARY_OUTPUT_PATH ${PROJECT_BINARY_DIR}/develop)
ENDIF()
